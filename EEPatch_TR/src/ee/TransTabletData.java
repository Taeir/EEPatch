...
implements IInventory
{
	...
	private HashMap<Integer, Integer[]> knowledge = new HashMap<Integer, Integer[]>();
	...
	public void a(NBTTagCompound var1) {
		...
		this.knowledge = new HashMap<Integer, Integer[]>();
	...
	public void b(NBTTagCompound var1)
	{
		...
		for (int var3 = 0; var3 < this.knowledge.size(); ++var3)
		{
			if (this.knowledge.get(Integer.valueOf(var3)) == null)
				continue;
			NBTTagCompound var4 = new NBTTagCompound();
			var4.setInt("item", this.knowledge.get(Integer.valueOf(var3))[0].intValue());
			var4.setInt("meta", this.knowledge.get(Integer.valueOf(var3))[1].intValue());
			var2.add(var4);
		}
	...
	public HashMap<Integer, Integer[]> getKnowledge()
	{
	...
	public void pushKnowledge(int var1, int var2)
	{
		...
		int var3 = 0; while (this.knowledge.get(Integer.valueOf(++var3)) != null);
	...
	public boolean playerKnows(int var1, int var2)
	{
		...
		for (int var4 = 0; this.knowledge.get(Integer.valueOf(++var4)) != null; )
		{
			int var5 = this.knowledge.get(Integer.valueOf(var4))[0].intValue();
			int var6 = this.knowledge.get(Integer.valueOf(var4))[1].intValue();
	...
	public void rejectItem(int var1)
	{
		if ((this.player == null) || 
				...
				(EEProxy.isClient(this.player.world)) || 
				(getItem(var1) == null))
			return;
